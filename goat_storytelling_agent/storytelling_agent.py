...
import time                #Time access and conversions. This module provides various time-related functions
import re                       #RegEx for searching/splitting text
import json                        #For exporting/importing JSON data
...
#import transformers                        #reminder that transformers is imported, but only if the backend is HF TGI. added here as comment only.

from goat_storytelling_agent import utils                #functions to remove or keep the last N words in a string
from goat_storytelling_agent.plan import Plan                #functions to process a story plan that has been generated by the LLM


SUPPORTED_BACKENDS = ["hf", "llama.cpp"]                        #list of supported API's where a request to the LLM can be sent

"""
FUNCTION MAP
generate_story                                                  #run from the user's script
        init_book_spec
                prompts.init_book_spec_messages
                query_chat
                parse_book_spec
                prompts.missing_book_spec_messages
                query_chat
        enhance_book_spec
                prompts.enhance_book_spec_messages
                query_chat
                parse_book_spec
                parse_book_spec
        create_plot_chapters
                prompts.create_plot_chapters_messages
                query_chat
                plan.parse_text_plan
        enhance_plot_chapters
                plan.plan_2_str
                prompts.enhance_plot_chapters_messages
                query_chat
                Plan.parse_act
                query_chat
                Plan.plan_2_str
        split_chapters_into_scenes
                Plan.act_2_str
                prompts.plit_chapters_into_scenes_messages
                query_chat
        write_a_scene
                Plan.plan_2_str
...
class StoryAgent:
    ...
    # Purpose: NOT SURE THIS FUNCTION IS USED AT ALL
    # Inputs: 
    # Calls: 
    # Returns: 
